...
const config: Config = {
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      {
        name: 'description',
        content: '조이 언어발달센터는 자폐스펙트럼장애, 지적장애, 유창성(말더듬)장애, 단순 언어발달장애, 조음(발음) 장애 아동의 기능적이고 즐거운 언어치료 수업을 만들어가고자 합니다. (원주 언어발달센터, 원주 기업도시 언어발달센터, 원주 지정면 언어발달센터, 원주 언어치료, 원주 기업도시 언어치료, 원주 지정면 언어치료)',
      }
    ],
